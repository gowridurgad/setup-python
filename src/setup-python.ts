...
async function run() {
  ...
  // Issue #1087: on Linux, scope the tool-cache root by OS id + version so
  // self-hosted runners that switch between distro versions do not reuse a
  // Python built against a different glibc / OpenSSL.
  scopeToolCacheByOs();
