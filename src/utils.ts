 ...
 */
export function getOsSuffix(): string | null {
  if (!IS_LINUX) return null;
  if (process.env['RUNNER_ENVIRONMENT'] === 'github-hosted') return null;
  try {
 ...
 * not by OS.
 */
export function getCacheArchitecture(architecture: string): string {
